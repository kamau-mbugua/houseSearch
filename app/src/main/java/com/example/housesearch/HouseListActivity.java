...
public class HouseListActivity extends AppCompatActivity {
    ...
    ActivityHouseListBinding hotelListBinding;
...
//                    productSearch(s.toString());
                    ...
                    mAdapter = new RecyclerAdapter(HouseListActivity.this, mHotel);
            ...
            mDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                        House model = postSnapshot.getValue(House.class);
...
//                        }
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(HouseListActivity.this, "Permission Denied...", Toast.LENGTH_SHORT).show();
                    Toast.makeText(HouseListActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    circleP_bar.setVisibility(View.INVISIBLE);
                }
            });
        } else {
...
//                    Products filteredProduct = snapshot.getValue(Products.class);
                    House modelFiltered = snapshot.getValue(House.class);

                    if (hotelLocation.equals(null)) {
                        Toast.makeText(HouseListActivity.this, "Location is null", Toast.LENGTH_SHORT).show();
                    } else {
...
//                            nameList.add(pName);
                        ...
                        if (hotelName.equals(null)) {
                            Toast.makeText(HouseListActivity.this, "Hotel Name is Null", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            if (tagList.equals(null)) {
                                Toast.makeText(HouseListActivity.this, "Tag List is null", Toast.LENGTH_SHORT).show();
                            } else {
                ...
                if (!filteredmHotel.isEmpty()) {
                    ...
                    mAdapter = new RecyclerAdapter(HouseListActivity.this, filteredmHotel);
                    recyclerView.setAdapter(mAdapter);
                } else {
                    defaultView.setVisibility(View.VISIBLE);
